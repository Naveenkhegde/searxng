...
LABEL maintainer="searxng <${GIT_URL}>" \
      ...
      org.label-schema.usage="https://github.com/Naveenkhegde/searxng-docker" \
      ...
      org.opencontainers.image.documentation="https://github.com/Naveenkhegde/searxng-docker"
